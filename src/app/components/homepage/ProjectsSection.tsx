...
export default function ProjectsSection() {
  ...
  const projects: Project[] = [
    ...
    {
      id: 4,
      title: t("projects.items.seoResults.title"),
      description: t("projects.items.seoResults.description"),
      image: "/placeholder-project-fredon.png",
      category: "marketing",
      technologies: [
        "Google Analytics",
  ...
  const categories = [
    { id: "all", label: t("projects.categories.all"), icon: Filter },
    { id: "web", label: t("projects.categories.web"), icon: Code },
    { id: "mobile", label: t("projects.categories.mobile"), icon: Smartphone },
    { id: "design", label: t("projects.categories.design"), icon: Palette },
    { id: "marketing", label: t("projects.categories.marketing"), icon: Globe },
  ];
  ...
  const getTechIcon = (tech: string) => {
    if (tech.includes("js") || tech.includes("React") || tech.includes("Next"))
      return <Code className="w-4 h-4" />;
    if (tech.includes("Figma") || tech.includes("Adobe"))
            ...
            <h2 className="text-3xl lg:text-5xl font-bold text-slate-900 dark:text-white mb-6">
              {
                t(
                  ...
                  "Project {highlight}Showcase{/highlight}"
                ).split("{highlight}")[0]
              }
          ...
          <motion.div variants={itemVariants} className="text-center">
            <div className="bg-gradient-to-r from-slate-50 to-blue-50 dark:from-slate-800 dark:to-slate-700 rounded-2xl p-8 lg:p-12">
              <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">
                {t("projects.cta.readyToStart")}
              </h3>
              <p className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto">
                {t("projects.cta.readyToStartDescription")}
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                >
                  <Button variant="outline" size="xl">
                    {t("projects.cta.viewFullPortfolio")}
                  </Button>
                </a>
              </div>
            </div>
