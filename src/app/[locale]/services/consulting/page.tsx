...
import { HeadphonesIcon, TrendingUp, Server, Shield, Users } from "lucide-react";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    keywords: "IT poradenství brno, konzultace technologií, digitální transformace, IT infrastruktura, kybernetická bezpečnost audit, IT strategie",
  };
}
...
export default async function ConsultingPage({ params }: Props) {
  ...
  const breadcrumb = generateBreadcrumbSchema([
    ...
    { name: "IT Poradenství", url: `/${locale}/services/consulting` },
  ], baseUrl);
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              <div className="border border-slate-800/50 rounded-lg p-6 bg-glass-bg backdrop-blur-glass hover:border-neon-cyan/40 transition-all">
                ...
                <h3 className="text-xl font-bold text-terminal-light mb-2 font-mono">
                  {t("consulting.features.strategy.title")}
                </h3>
                <p className="text-terminal-light/70">
                  {t("consulting.features.strategy.description")}
                </p>
              </div>
              ...
              <div className="border border-slate-800/50 rounded-lg p-6 bg-glass-bg backdrop-blur-glass hover:border-neon-purple/40 transition-all">
                <Server className="w-10 h-10 text-neon-purple mb-4" />
                <h3 className="text-xl font-bold text-terminal-light mb-2 font-mono">
                  {t("consulting.features.infrastructure.title")}
                </h3>
                <p className="text-terminal-light/70">
                  {t("consulting.features.infrastructure.description")}
                </p>
              </div>
              ...
              <div className="border border-slate-800/50 rounded-lg p-6 bg-glass-bg backdrop-blur-glass hover:border-neon-cyan/40 transition-all">
                ...
                <h3 className="text-xl font-bold text-terminal-light mb-2 font-mono">
                  {t("consulting.features.security.title")}
                </h3>
                <p className="text-terminal-light/70">
                  {t("consulting.features.security.description")}
                </p>
              </div>
              ...
              <div className="border border-slate-800/50 rounded-lg p-6 bg-glass-bg backdrop-blur-glass hover:border-neon-purple/40 transition-all">
                ...
                <h3 className="text-xl font-bold text-terminal-light mb-2 font-mono">
                  {t("consulting.features.training.title")}
                </h3>
                <p className="text-terminal-light/70">
                  {t("consulting.features.training.description")}
                </p>
              </div>
            </div>
